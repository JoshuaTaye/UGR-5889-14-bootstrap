...
function sendMessage(message) {
  ...
  if (message === "Talk to me") {
    ...
    botReply = `
      You can download my CV <a href="files/CV.docx" class="link-info" download>here</a>.
    `;
  } else {
...
function showContact() {
  ...
  if (contactInfo.classList.contains("visually-hidden")) {
    contactInfo.classList.remove("visually-hidden");
  } else {
    contactInfo.classList.add("visually-hidden");
  }
}
